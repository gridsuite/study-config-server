...
class SpreadsheetConfigCollectionIntegrationTest {
    ...
    private List<SpreadsheetConfigInfos> createSpreadsheetConfigsWithFilters() {
        ...
        List<GlobalFilterInfos> globalFiltersConfig2 = List.of(
                GlobalFilterInfos.builder().uuid(UUID.randomUUID()).filterType("country").label("Another Global Filter").unselectedDate(null).build()
        );
    ...
    private List<SpreadsheetConfigInfos> createUpdatedSpreadsheetConfigsWithFilters() {
        ...
        List<GlobalFilterInfos> globalFiltersConfig1 = Arrays.asList(
                GlobalFilterInfos.builder().uuid(UUID.randomUUID()).filterType("country").label("Updated Filter 1").unselectedDate(null).build(),
                GlobalFilterInfos.builder().uuid(UUID.randomUUID()).filterType("country").label("Updated Filter 2").unselectedDate(null).build(),
                GlobalFilterInfos.builder().uuid(UUID.randomUUID()).filterType("country").label("Updated Filter 3").unselectedDate(null).build()
        );
        ...
        List<GlobalFilterInfos> globalFiltersConfig2 = List.of(
                GlobalFilterInfos.builder().uuid(UUID.randomUUID()).filterType("country").label("Updated Other Filter").unselectedDate(null).build()
        );
        ...
        List<GlobalFilterInfos> globalFiltersConfig3 = List.of(
                GlobalFilterInfos.builder().uuid(UUID.randomUUID()).filterType("country").label("Third Config Filter").unselectedDate(null).build()
        );
